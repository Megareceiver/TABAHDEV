	...
	Class F4 {
		...
		function getData($data, $target){
			...
			switch($target){
				...
				case "f403": $resultList = $this->requestDataDplega('f4', 'f403'); break;
				...
				case "f431": $resultList = $this->requestDataDplega('f4', $target); break;
				...
				case "timWilayah" :  $resultList = getTimWilayahListSection($data); break;
